...
const Projects = () => {
  ...
  const handlechange =(data)=>{
    toast.success("project added", toastOptions);
    setProjects(data.value)
    setaddnewproject(data.check)
  }

  const showdeatils=(proj)=>{
    console.log(proj);
    setprojectdata(proj)
  ...
  return (
    <div className="relative w-full h-screen bg-blue-100 dark:bg-gray-700">
      ...
      <div className="flex flex-row justify-between">
        {/* projects table */}
        <div className="w-1/2 mx-6 mt-10">
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {projects.map((proj,pid)=>(
                  <tr key={pid} className="bg-white border-b dark:bg-gray-900 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
        ...
        {/* newproject form */}
        <div className={addnewproject?("relative flex flex-col items-center w-2/5 mx-10"):("hidden")}>
        <button
        ...
        <div className={projectdetail?("relative flex flex-col items-center w-2/5 mx-10"):("hidden")}>
        <button
